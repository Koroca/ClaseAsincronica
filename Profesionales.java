    ...
    public void imprimirDatos(){
     ...
     +"\n Cual materia da : "+materia);
      ...
      public static void main(String[] args) {
        ...
        profesional1.setTitulos(JOptionPane.showInputDialog("Ingrese cuantos titulos tiene el profesor"));
        profesional1.setGrado(JOptionPane.showInputDialog("Ingrese cual grado da el profesor"));
        profesional1.setMateria(JOptionPane.showInputDialog("Ingrese cual materia da el profesor"));
